...
ifeq ($(USE_CAFFE_CONVERTER), 1)
	BIN +=  bin/caffe_converter bin/caffe_mean_converter bin/cxxnet_converter
endif
...
bin/cxxnet_converter: tools/caffe_converter/cxxnet_converter.cpp $(OBJ) $(OBJCXX11) $(LIB_DEP) $(CUDEP) 
